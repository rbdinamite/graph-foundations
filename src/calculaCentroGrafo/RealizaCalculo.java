...
public class RealizaCalculo {
	...
	public RealizaCalculo(String Svertices,
		...
		Tela.lbResultado1.setText(MostraResultado(CalculaCentroGrafo(MontaMatrizDistancia(vertices, listaAdjacencia), vertices), vertices));
